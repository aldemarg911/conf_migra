--
-- 00_Mig_Companias.sql : Crea los registros de configuración
--
DECLARE
  --
   vncarga     mig_cargas.ncarga %TYPE;
   v_texto     VARCHAR2(50) := 'MIG_COMPANIAS_TXT';
  -- 
BEGIN
  --
  SELECT sncarga.nextval INTO vncarga FROM dual;
     ...
     VALUES
        (vncarga, 7 /*DOC-108![mig_cargas_tab_mig]*/, 'Inserts Directos', 'MIG_COMPANIAS');

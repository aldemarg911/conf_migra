DECLARE
    /******************************************************************************
    NOMBRE:       50_Mig_age_corretaje_v01.sql
    PROPÓSITO:    Procedimiento que ejecuta carga de AGE_CORRETAJE - PRODUCCION
...
*/
   ...
   --
    CURSOR lc_mig_age_corretaje IS
     ...
     --SELECT COUNT(*)
      FROM mig_age_corretaje_cl2 a, mig_seguros s
     WHERE 1 = 1
...
SELECT COUNT(*) FROM mig_age_corretaje WHERE sseguro = 0;
...
/*SELECT * FROM mig_logs_axis s WHERE s.ncarga = 17431 AND s.seqlog > 0;

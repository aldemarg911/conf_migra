...
BEGIN
  ...
  SELECT pac_contexto.f_inicializarctx(pac_parametros.f_parempresa_t(24, 'USER_BBDD'))
    ...
    FROM dual;
    --
    -- 0. 00_Mig_Seguros_v01.sql (Crea registros de carga)
    -- 1. 01_Mig_Seguros_v01.sql (Migra registros de _CONF a MIG_)
    -- 2. (02_Mig_Movseguro_v01.sql & 03_Mig_Movseguro_v01.sql )(Migra registros de _CONF a MIG_) Requerido para que se calcule [seguros.nanuali]
    -- 3. SE DEBE CARGAR MIG_HISTORICOSEGUROS
    -- 3. Ejecutar este script
    -- 4. Actualizar T[ms] documento DOC-108
    --
    pac_mig_axis_conf.p_migra_cargas(pid     => 'MIG_SEGUROS_TXT',
                                     ptipo   => 'C',
                                     pncarga => vncarga);
    --

--
-- 60_Mig_pregunseg_v01.sql : Crea los registros de configuración
--
DECLARE
  --
...
BEGIN
 ...
 -- SELECT sncarga.nextval INTO vncarga FROM dual;
     ...
     VALUES
        (vncarga, 24, f_sysdate, f_sysdate, 'OK', 'MIG_PREGUNSEG_TXT');
     --
    INSERT INTO mig_cargas_tab_mig
            (ncarga, ntab, tab_org, tab_des)     VALUES
            (vncarga, 24 /*DOC-108![mig_cargas_tab_mig]*/, 'Inserts Directos', 'MIG_PREGUNSEG');
     --

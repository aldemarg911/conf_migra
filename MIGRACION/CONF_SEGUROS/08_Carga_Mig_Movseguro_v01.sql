-- 08_Carga_Movseguros_v01
DECLARE
   vdummy            NUMBER;
   vncarga           mig_cargas.ncarga%TYPE := 17423;/*Actualizar de acuerdo a script 02_Mig_Movseguro_v01.sql*/
   v_nerr            NUMBER;
   v_cant            NUMBER;
   v_seqlog          NUMBER := 0;
   --
...
BEGIN
  ...
  SELECT pac_contexto.f_inicializarctx(pac_parametros.f_parempresa_t(24, 'USER_BBDD'))
    ...
    FROM dual;
    --
    -- 0. 02_Mig_Movseguro_v01.sql (Crea registros de carga)
    -- 1. 03_Mig_Movseguro_v01.sql (Migra registros de _CONF a MIG_)
    -- 2. -void-
    -- 3. Ejecutar este script
    -- 4. Actualizar T[ms] documento DOC-108
    --
    pac_mig_axis_conf.p_migra_cargas(pid     => 'MIG_MOVSEGURO_TXT',
                                     ptipo   => 'C',
                                     pncarga => vncarga);
    --

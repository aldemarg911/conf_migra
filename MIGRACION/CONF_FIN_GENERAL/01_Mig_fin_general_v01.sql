--
-- 01_Mig_fin_general_v01.sql : Crea los registros de configuración
--
DECLARE
  --
   vncarga     mig_cargas.ncarga %TYPE;
   v_texto     VARCHAR2(50) := 'MIG_FIN_GENERAL_TXT';
  -- 
BEGIN
  --
...
END;
--
SELECT * FROM mig_cargas s WHERE s.ncarga = 17419 FOR UPDATE;
SELECT * FROM mig_cargas_tab_mig s WHERE s.ncarga = 17419 FOR UPDATE;
...
--
SELECT * FROM MIG_FIN_ENDEUDAMIENTO_cl1;
MIG_FIN_D_RENTA
MIG_FIN_ENDEUDAMIENTO

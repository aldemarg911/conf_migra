DECLARE
    ...
    PROPÓSITO:    Procedimiento que ejecuta carga de PTPPLP - PRODUCCION
...
*/
   ...
   --
    CURSOR lc_mig_ptpplp IS
     SELECT 17465 NCARGA, 1 CESTMIG, a.producto, a.póliza, 0 sseguro, a.sinestro, 0 nsiniestro, a.fcalculo, 
            a.ipplpsd, a.ipplprc, a.ivalbruto, a.ivalpago, a.ippl, a.ippp
            , a.PóLIZA, a.sinestro
    --Select count(*)
       FROM mig_ptpplp_cl1 a, MIG_SEGUROS c, MIG_SINIESTROS s
      WHERE 1 = 1
        AND a.PóLIZA  = c.mig_pk --(+) --Sacar consulta de los excluidos

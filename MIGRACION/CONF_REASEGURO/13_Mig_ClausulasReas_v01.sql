--
-- 13_Mig_ClausulasReas_v01.sql : Crea los registros de configuración
--
DECLARE
  --
   vncarga     mig_cargas.ncarga %TYPE;
   v_texto     VARCHAR2(50) := 'MIG_CLAUSULAS_REAS_TXT';
  -- 
BEGIN
  --
  SELECT sncarga.nextval INTO vncarga FROM dual;
    ...
    INSERT INTO mig_cargas_tab_mig
            ...
            (vncarga, 63 /*DOC-108![mig_cargas_tab_mig]*/, 'Inserts Directos', REPLACE(v_texto, SUBSTR(v_texto, -4)));
     --
...
END;
--
SELECT * FROM mig_cargas s WHERE s.ncarga = 17414 FOR UPDATE;

--
-- 22_Mig_Sin_Tramita_Pago_v01.sql : Crea los registros de configuración
--
DECLARE
  --
   vncarga     mig_cargas.ncarga %TYPE := 17445;
   v_texto     VARCHAR2(50) := 'MIG_SIN_TRAMITA_PAGO_TXT';
  -- 
BEGIN
  --
 -- SELECT sncarga.nextval INTO vncarga FROM dual;
  ...
  --
END;
--SELECT * FROM mig_cargas s WHERE s.ncarga = 17445;

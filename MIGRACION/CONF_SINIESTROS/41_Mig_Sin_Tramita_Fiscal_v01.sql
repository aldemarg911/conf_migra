DECLARE
    /******************************************************************************
    NOMBRE:       41_Mig_Sin_Tramita_Fiscal_v01.sql
    PROPÓSITO:    Procedimiento que ejecuta carga de MIG_SIN_TRAMITA_FISCAL - PRODUCCION
...
*/
   ...
   --
    ...
    --SELECT COUNT(*)
      FROM mig_sin_tramita_fiscal_cl1 a, mig_sin_siniestro s, mig_sin_tramita_judicial t
     WHERE 1 = 1
      ...
      ORDER BY a.mig_pk;
      --
        --SELECT * FROM mig_sin_tramita_fiscal_conf s;
        --SELECT * FROM mig_sin_tramita_fiscal s for update WHERE s.mig_pk = 'RD30094778';
...
BEGIN
  ...
  LOOP
   ...
   -----------------------------------------
END;
--DELETE FROM mig_sin_tramita_fiscal;
SELECT * FROM mig_sin_tramita_fiscal_conf;
SELECT * FROM mig_sin_tramita_fiscal s ;
SELECT * FROM mig_sin_tramita_fiscal s WHERE s.crespue IS NULL
...
--SELECT * FROM control_error s WHERE s.donde = '03_mig_sin_tramita_fiscal' and seqerror > 9537681 order by seqerror;
DELETE FROM control_error s WHERE s.donde = '03_mig_sin_tramita_fiscal'
SELECT * FROM control_error s WHERE s.donde = '45_mig_sin_tramita_fiscal' order by seqerror;
SELECT * FROM mig_personas WHERE mig_pk IN (SELECT DISTINCT mig_fk FROM mig_sin_tramita_fiscal);
SELECT * FROM mig_sin_tramita_fiscal s, mig_personas p

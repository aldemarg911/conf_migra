...
SELECT * FROM mig_direcciones_conf s FOR UPDATE;
SELECT * FROM mig_logs_axis s WHERE ncarga = 20041 order by ncarga;
...
--
-- Origen
SELECT * FROM mig_personas s where mig_pk IN ('A0243127', 'A0555140', 'A0543803', 'A0077138', '900930211') FOR UPDATE;
